  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="220">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['basic:material:edit']">修改</el-button>
          <el-button link type="primary" icon="Plus" @click="handleAdd(scope.row)" v-hasPermi="['basic:material:add']">新增</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['basic:material:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script setup name="BasicMaterial">
import { listMaterial, getMaterial, delMaterial, addMaterial, updateMaterial } from "@/api/basic/material"
...
function getList() {
  ...
  listMaterial(queryParams.value).then(response => {
    materialList.value = proxy.handleTree(response.data, "id", "parentId")
    loading.value = false
  })
}
...
function getTreeselect() {
  listMaterial().then(response => {
    ...
    materialOptions.value.push(data)
  })
}
