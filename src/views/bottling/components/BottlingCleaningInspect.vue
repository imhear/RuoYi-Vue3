      ...
      <table class="row-table step-table-native" cellspacing="0" cellpadding="0">
        ...
        <tr style="height: 28px;">
          ...
          <td class="td-sign" rowspan="13" style="border-top-color: #fff;">
            ...
            <!-- 检查按钮：检查显示开关开启且检查人未提交时显示 -->
            <div v-if="form.inspectShowHide === '0' && !form.inspectorTime" style="margin-top: 8px;">
              <el-button type="warning" size="small" @click="handleInspect">检查</el-button>
            </div>
          </td>
        </tr>
...
function handleInspect() {
  emit('cleaningInspect', { cleaningId: currentCleaningId.value })
}
...
const emit = defineEmits(['cleaningInspect', 'submit'])
