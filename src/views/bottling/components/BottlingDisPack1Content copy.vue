        ...
        <td>
          <div style="padding: 0px 16px;">
            <div class="step-text">
              ...
              消毒时间 {{ record.s2OzoneDesinfectionStartTime ? parseTime(record.s2OzoneDesinfectionStartTime, '{h}:{i}') : '' }} 至 {{ record.s2OzoneDesinfectionEndTime ? parseTime(record.s2OzoneDesinfectionEndTime, '{h}:{i}') : '' }}
              ...
              <br/>
              <span style="margin-left: 30px;">
              消毒时间 {{ record.s2DryingDesinfectionStartTime ? parseTime(record.s2DryingDesinfectionStartTime, '{h}:{i}') : '' }} 至 {{ record.s2DryingDesinfectionEndTime ? parseTime(record.s2DryingDesinfectionEndTime, '{h}:{i}') : '' }}
              ...
              <br/>
              <span style="margin-left: 30px;">
              消毒时间 {{ record.s2HighDryingDesinfectionStartTime ? parseTime(record.s2HighDryingDesinfectionStartTime, '{h}:{i}') : '' }} 至 {{ record.s2HighDryingDesinfectionEndTime ? parseTime(record.s2HighDryingDesinfectionEndTime, '{h}:{i}') : '' }}
               <!-- ，共{{ record.s2HighDryingDesinfectionCost || '' }}分钟 -->
              </span>
              <br/>
        ...
        <td>
          <div style="padding: 0px 16px;">
            <div class="step-text">
              ...
              <br/>
              <span style="margin-left: 30px;">
              消毒时间 {{ record.s3OzoneDesinfectionStartTime ? parseTime(record.s3OzoneDesinfectionStartTime, '{h}:{i}') : '' }} 至 {{ record.s3OzoneDesinfectionEndTime ? parseTime(record.s3OzoneDesinfectionEndTime, '{h}:{i}') : '' }}
